...
class Home extends Component {
    ...
    async componentDidMount() {
        ...
        setTimeout(() => this.scrollView.scrollTo({ x: 150 }) , 10);        
    }
    render() {
        return (
            <Container>
                ...
                <TabsContainer>
                    <HorizontalScroll ref={ (scrollView) => {this.scrollView = scrollView} }>
                        <CardFunc backgroundCard="#1C709E" title="Teste de TDAH" backgroundFooter="#0B2837" nameIcon="md-clipboard" textFooter="Fazer teste" description="Desenvolvemos um teste simples para calcular o indice de TDAH, lembrando que isso foi baseado em pesquisas."/>                    
                        <CardFunc backgroundCard="#1C9E9E" title="Podcasts TDAH" backgroundFooter="#0D4C4C" nameIcon="md-headset" textFooter="Ouvir podcasts" description="Aqui você encontrará podcasts relacionados a TDAH, toda semana tem um novo, e você ainda poderá ouvir os antigos."/>                    
                        ...
                        <CardFunc backgroundCard="#1C9E49" title="Fórum" backgroundFooter="#073918" nameIcon="md-chatboxes" textFooter="Postar/Comentar" description="Nesse ambiente você poderá postar dúvidas, comentar em outros posts podendo manter o anonimato se preferir ou não."/>                    
                    </HorizontalScroll>
                </TabsContainer>             
                <Content>
